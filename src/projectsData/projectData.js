...
export const projectsArray = [
  ...
  },
  {
    ...
    description:
      "This was the capstone project for my coding bootcamp. The goal of the project was to build a fullstack application within react. We build the backend using mongodb and used GraphQL to authenticate, render and save data. We also wanted to experiment with using a component library that we have never used before. We chose to use Chakra UI because it aheres to WAI-ARIA standards for accessiblity.",
    repository: "https://github.com/AlexanderLeino/Netflix-and-Grill",
    icons: [
      <ImHtmlFive />,
      <SiJavascript />,
...

  {
    title: "My Portfolio",
    description:
      "I built this portfolio to showcase my previous works. The Goal of the project was to create and implement a dark and light theme, I also wanted to use HashNodes api to get all of my previous blog posts and have them visible under the articles tab",
    deploy: "https://alexanderleino.github.io/Netflix-and-Grill/",
    repository: "https://github.com/AlexanderLeino/Netflix-and-Grill",
    icons: [<ImHtmlFive />, <SiJavascript />, <DiCss3 />, <BsBootstrap />],
    image: portfolio,
